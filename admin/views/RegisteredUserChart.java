...
public class RegisteredUserChart extends JPanel{
    ...
    private void initComponents(){
        ...
        chartPanelRegistered.setTitle("Số lượng người đăng ký mới năm 2024", "Số lượng người dùng", "Tháng");
    ...
    private JPanel createStatisticsPanel() {
        ...
        // Total Users Card
        JPanel totalCard = createStatCard("Tổng số người đăng ký", "0", new Color(33, 150, 243));
